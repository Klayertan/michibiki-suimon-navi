...
describe('Stage 3C survey and observation workflows', () => {
  beforeEach(() => {
    ...
    useLiveGnssStore.getState().applySnapshot({ connectionState: 'connected', currentFix: null, baudRate: 115200, lineCount: 0, malformedLineCount: 0, message: null, transportLabel: 'test' })
    mapInstance = null
  })
